...
/**
 * Das ist die Synchrone Schnittstelle für eine RPC-fähige Klasse zur
 * Erstellung von Reports. Diese Schnittstelle benutzt die gleiche
 * Realisierungsgrundlage wir das Paar ShopITAdministration und
 * ShopITAdministrationImpl.
 * <p>
 * Durch den ReportGenerator werden die Berichte, also Reports erstellt, welche
 * * die Menge von Daten bzgl. Bestimmter Sachverhalte des Systems
 * zweckspezifisch darstellen.
 * </p>
 * <p>
 * Die Klasse erstellt mit Hilfe von create�-Methoden den Report. Jede dieser
 * Methoden besitzt eine dem Anwendungsfall entsprechende Parameterliste. Diese
 * Parameter ben�tigt der der Generator, um den Report erstellen zu können.
 * </p>
 * <p>
 * Bei neu hinzukommenden Bedarfen an Berichten, kann diese Klasse auf einfache
 * Weise erweitert werden. Hierzu k�nnen zus�tzliche create�-Methoden
 * implementiert werden. Die bestehenden Methoden bleiben davon unbeeinflusst,
 * so dass bestehende Programmlogik nicht ver�ndert werden muss.
 * </p>
 * 
 * @author ilona
 *
...
public interface ReportGenerator extends RemoteService {
	...
	/**
	 * Initialisierung des Objekts. Diese Methode ist vor dem Hintergrundon GWT RPC
	 * zus�tzlich zum No Argument Constructor, der implementieren Klasse
