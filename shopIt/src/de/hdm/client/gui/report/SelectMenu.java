...
public class SelectMenu extends VerticalPanel {
	 ...
	 * kommen
	 */
	private Label beitragLabel = new Label("Wahlen Sie die gewünschte Beitragsstatistik aus: ");
	private Button shopButton = new Button("Shop");
	private Button timeButton = new Button("Zeitraum");
	private Button shopTimeButton = new Button("Shop & Zeitraum");
	private Button zurueckButton = new Button("Zurück zu ShopIT");
